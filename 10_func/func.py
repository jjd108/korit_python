...
# def cheek_divide_seven(num):
#     if num % 7 == 0:
#         return True
#     else:
#         return False
#     print(cheek_divide_seven(15))
...
#어떤 함수가 실행되는 동안 임리 정의된 다른 함수를 호출하여 실행하는 역할
...
#콜백함수 숫자 두개를 매개변수로 전달하고 해당 숫자 두개를 나누는 함수로 정리
#나머지가 0이면 True 0이 아니면  False => 삼한연산자
# def calculator (x, y,  operation):
